...
mvn install:install-file -Dfile=target/swiftboot-data-2.3.1-tests.jar -DgroupId=com.github.swiftech -DartifactId=swiftboot-data -Dclassifier=tests -Dpackaging=test-jar -f swiftboot-data/pom.xml
