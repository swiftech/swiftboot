...
public class GoodsOrderRelController {
    ...
    public
    @ResponseBody
    HttpResponse<GoodsOrderRelCreateResult> goodsOrderRelCreate(
    ...
    public
    @ResponseBody
    HttpResponse<GoodsOrderRelSaveResult> goodsOrderRelSave(
    ...
    public
    @ResponseBody
    HttpResponse<GoodsOrderRelResult> goodsOrderRelQuery(
    ...
    public
    @ResponseBody
    HttpResponse<GoodsOrderRelListResult> goodsOrderRelList() {
    ...
    public
    @ResponseBody
    HttpResponse<Void> goodsOrderRelDelete(
    ...
    public
    @ResponseBody
    HttpResponse<Void> goodsOrderRelDeleteList(
    ...
    public
    @ResponseBody
    HttpResponse<Void> goodsOrderRelDeleteByFk(
    ...
    public
    @ResponseBody
    HttpResponse<Void> goodsOrderRelPurge(
            @RequestBody @Validated @ApiParam("商品订单关系ID") IdCommand command) {
    ...
    public
    @ResponseBody
    HttpResponse<Void> goodsOrderRelPurgeList(
            @RequestBody @Validated @ApiParam("商品订单关系ID列表") IdListCommand command) {
    ...
    public
    @ResponseBody
    HttpResponse<Void> goodsOrderRelPurgeByFk(
            @RequestBody @Validated @ApiParam("商品订单关系关系ID") GoodsOrderRelDelPurgeCommand command) {
