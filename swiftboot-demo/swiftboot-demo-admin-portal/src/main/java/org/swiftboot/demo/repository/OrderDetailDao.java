 ...
 **/
public interface OrderDetailDao extends PagingAndSortingRepository<OrderDetailEntity, String>, CrudRepository<OrderDetailEntity, String>,
        OrderDetailCustomizeDao {
