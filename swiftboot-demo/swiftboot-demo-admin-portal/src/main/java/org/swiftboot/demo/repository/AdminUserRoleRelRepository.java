...
import org.swiftboot.demo.model.AdminUserRoleRelEntity;
 ...
 * @author swiftech
 **/
public interface AdminUserRoleRelRepository extends PagingAndSortingRepository<AdminUserRoleRelEntity, String>,
        CrudRepository<AdminUserRoleRelEntity, String> {
