 ...
 **/
public interface GoodsRepository extends PagingAndSortingRepository<GoodsEntity, String>, CrudRepository<GoodsEntity, String>,
        BooleanLogicalDeleteExtend<GoodsEntity> {
